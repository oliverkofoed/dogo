module github.com/oliverkofoed/dogo
...
require (
	...
	github.com/oliverkofoed/gokit v0.0.0-20210517121239-13b342354a98
	github.com/oliverkofoed/jet v2.0.2-0.20210414115421-f6aeddcec219+incompatible
